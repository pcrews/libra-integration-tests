# Copyright 2013 Hewlett-Packard Development CompanyL.P.
#
# Licensed under the Apache LicenseVersion 2.0 (the "License"); you may
...
def get_parser():
    ...
    # parser
    ##########
    description = 'test_loadbalancer_operations.py - integration test suite for libra lbaas service'
    ...
    parser.add_argument('--demo_wait_time',
                       ...
                       dest='demowaittime',
                       default=None,
                       help='seconds to wait during certain tests for manual testingvalidationetc'
                       )
